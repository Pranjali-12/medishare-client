...
function MedicineUpload() {
  ...
  return (
   <div className="h-screen flex flex-wrap overflow-hidden">

  <div className="w-full sm:w-1/2 px-4 sm:px-24 py-10">
    <div className="text-3xl font-spartan my-5">Upload Medicine</div>
  ...
  <div className="hidden sm:block w-full sm:w-1/2 pl-10">
    <div className='bg-[#1CB5BD] h-full'>
    <img src={require("../assets/UploadMed.png")} alt="" className='-ml-24 pt-10'/>
    </div>
