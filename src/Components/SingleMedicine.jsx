...
//               </div>
//               <div className='mt-8'>
//               <button  className='bg-[#1CB5BD] text-white font-semibold rounded-md text-xl py-2 px-6 '>BUY NOW</button>
...
//                 />
//                               <button  className='bg-[#1CB5BD] text-white font-semibold rounded-md text-xl py-2 px-6 '>Send Request</button>
...
//                       />
//                       </div>
//                       <button className='bg-[#1CB5BD] text-white font-semibold rounded-md text-xl py-2 px-6 mt-5'>Send Request</button>
//                     </div>
//                   )}
//                 </div>
//               </div>
...
const SingleMedicine = (props) => {
  ...
  const handleRequestSend = () => {
    if (parseInt(medicineQuantity) > parseInt(props.quantity)) {
      ...
      // Logic to send request
      setErrorMessage('');
      // Navigate to the allreqmed page
      navigate('/reciever/allreqmed');
    }
  };
