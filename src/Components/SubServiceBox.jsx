...
const SubServiceBox = (props) => {
  ...
  return (
    <div  ><div className="max-w-sm  ps-6 pe-6 mx-4 my-4" style={{width:"19rem",height:"17.5rem",boxShadow:"rgba(0, 0, 0, 0.18) 4px 4px 4px",backgroundColor:"white",borderRadius:"15px"}}>
